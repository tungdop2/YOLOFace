...
def non_max_suppression_face(prediction, conf_thres=0.25, iou_thres=0.45, classes=None, agnostic=False, multi_label=False,
    ...
    max_nms = 1000000  # maximum number of boxes into torchvision.ops.nms()
